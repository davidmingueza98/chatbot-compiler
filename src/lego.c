  ...
  {
  {
    ...
    if ( (LA(1)==TXT) ) {
      ...
      if ( (LA(1)==MOVE) ) {
        ...
        if ( (LA(1)==WHILE) ) {
          whiler(zzSTR); zzlink(_root, &_sibling, &_tail);
        }
...
#endif
{
  ...
  local(zzSTR); zzlink(_root, &_sibling, &_tail);
...
#endif
{
  ...
  zzMake0;
  {
  evaluation(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
    if ( (setwd2[LA(1)]&0x8) ) {
      {
        ...
        {
        {
          ...
          if ( (LA(1)==MENOR) ) {
            ...
            if ( (LA(1)==MAYOR) ) {
              zzmatch(MAYOR); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
            }
...
#endif
{
  ...
  {
  {
    ...
    {
    if ( (LA(1)==TXT) ) {
      puta(zzSTR); zzlink(_root, &_sibling, &_tail);
    }
    else {
      if ( (LA(1)==NUM) ) {
        zzmatch(NUM); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
...
#endif
{
  ...
  zzMake0;
  {
  zzmatch(TXT); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
  zzmatch(PAR1);  zzCONSUME;
  zzmatch(TXT); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
